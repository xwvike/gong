...
func newKeyMap() keyMap {
	return keyMap{
		...
		TabNext:  key.NewBinding(key.WithKeys("tab", "shift+tab"), key.WithHelp("tab/h/l", "切换 定时/主题")),
		TabLeft:  key.NewBinding(key.WithKeys("h")),
		TabRight: key.NewBinding(key.WithKeys("l")),
		...
		OpenSource: key.NewBinding(key.WithKeys("o"), key.WithHelp("o", "原项目")),
